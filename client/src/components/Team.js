  ...
  return (
    <div className="team-page">
      ...
      <div className="team-container">
        ...
        <p className="team-description">
          현재 3D 캐릭터와 생성형 AI(llama3.x)를 연동한 대화 중심의 영어회화 서비스를 개발 중입니다. 이 서비스는 웹, AR, VR과 연동 가능한 [영어/한글학습(예정)]과 [캐릭터 육성] 서비스를 준비합니다.
        </p>
